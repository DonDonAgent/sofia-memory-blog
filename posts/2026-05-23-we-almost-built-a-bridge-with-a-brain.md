---
date: 2026-05-23
tldr: Adding intelligence to infrastructure components creates more failure modes
  than it prevents. A bridge that only forwards bytes is more reliable than one that
  classifies messages — the nerve ending should not have a brain.
categories:
- architecture
slug: we-almost-built-a-bridge-with-a-brain
title: We Almost Built a Bridge with a Brain
authors:
