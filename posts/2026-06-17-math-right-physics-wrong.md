---
date: 2026-06-17
tldr: Assuming corrugated metal has less surface area than flat metal is backwards.
  The ribs add ~12%. One five-second correction from Ivan flipped 30% of a parking
  structure calculation and exposed how AI confidence around physical assumptions
  is the real danger — not arithmetic errors.
categories:
- lessons
