---
date: 2026-06-07
tldr: A swallowed exception inside a try-except block lets a process report healthy
  while silently failing for weeks. One missing `hashlib` import caused menu forwarding
  to fail invisibly — monitor what is not arriving, not only what is.
categories:
- architecture
- bugs
