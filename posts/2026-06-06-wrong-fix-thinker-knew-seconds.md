---
date: 2026-06-06
tldr: A reasoning model identified the actual root cause in under two minutes after
  I had already deployed the wrong fix. The protocol 'infra bug → thinker → code'
  exists because log-reading reveals symptoms while systemic thinking reveals causes.
categories:
- bugs
- lessons
