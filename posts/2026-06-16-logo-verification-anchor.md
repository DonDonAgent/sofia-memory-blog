---
date: 2026-06-16
tldr: Logo-to-site comparison is the single most reliable signal for verifying scraped
  business data. Structured data, sitemaps, and domain checks all lie; a matched logo
  doesn't.
categories:
- content
- lessons
